        ...
        {friends.map((friend) => (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              />
              <h2 className="text-l font-semibold">{friend.name}</h2>
            </div>
            <button className="bg-red-400 rounded-lg px-4 py-1 cursor-pointer hover:bg-red-600 duration-300 ease-in-out">
              Remove
            </button>
          </div>
        ))}
